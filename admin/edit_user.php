...
$row_user = mysqli_fetch_array($data);

//$sql = "UPDATE tên_bảng SET tên_cột_1 = 'giá_trị_mới_1', tên_cột_2 = 'giá_trị_mới_2'"
if(isset($_POST['sbm'])) {
    ...
    $sql_update_user = "SELECT * FROM user WHERE user_mail = '$user_mail'";
    $query = mysqli_query($conn, $sql_update_user);
    $num_row = mysqli_num_rows($query);
    if($num_row > 0 && $user_pass != $user_re_pass) {
        $error_pass = '<div class="alert alert-danger">Mật khẩu không trùng!</div>';
    }
    else {
