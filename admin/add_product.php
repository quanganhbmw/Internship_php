...
?>
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
        ...
        if(isset($_POST['sbm'])) {
            ...
            $sql_add_prd = "INSERT INTO product(prd_name, prd_price, prd_warranty, prd_accessories, prd_promotion, prd_new, prd_details, cat_id, prd_status, prd_featured, prd_image) VALUES('$prd_name', '$prd_price', '$prd_warranty', '$prd_accessories', '$prd_promotion', '$prd_new', '$prd_details', '$cat_id', '$prd_status', '$prd_featured', '$prd_image')";
            mysqli_query($conn, $sql_add_prd);
